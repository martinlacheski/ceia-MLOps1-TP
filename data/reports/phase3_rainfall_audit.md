...
- Input OCR base: [`data/raw/rain/dataset_lluvias_diario_con_obs.csv`](https://github.com/martinlacheski/tp-ceia-amq/tree/main/data/raw/rain).
- Input manual de recuperación: [`data/raw/rain/rainfall_manual_recovered_months.csv`](https://github.com/martinlacheski/tp-ceia-amq/tree/main/data/raw/rain).
